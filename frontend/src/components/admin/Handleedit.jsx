...
function Handleedit() {
  ...
  const handleFileUpload = (e) => {
    ...
    setProductData((prev) => ({
      ...
      images: [
        ...prev.images,
        { file, alt: uploadedImageAlt.trim() || file.name },
      ],
    }));
    setUploadedImageAlt("");
  };
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-white bg-opacity-80 z-50">
        <div className="text-center">
          ...
          <p className="text-gray-700">
            {uploading ? "Uploading images..." : "Loading product..."}
          </p>
        </div>
      </div>
    );
        ...
        <div>
          ...
          <div className="mb-2 flex flex-col gap-2">
            ...
            <input required 
              ...
              onChange={(e) => setUploadedImageAlt(e.target.value)}
              className="border p-2 rounded w-full"
            />
          </div>
            ...
            {productData.images.map((img, index) => (
              <div key={index} className="relative group">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 bg-red-600 text-black text-lg px-2 py-1 "
                >
                  🗑
                </button>
              </div>
